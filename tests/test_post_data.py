...
class MyTestCase(unittest.TestCase):
    ...
    data_exists = {'data': {}, 'message': ['Not authenticated', 'Respondent Already exists'], 'status': 'failed'}
    new_data = {'data': {}, 'message': ['Not authenticated'], 'status': 'success'}
  ...
  "major_problems": {
    ...
    def test_post2db_new(self):
        import requests
        unique = random.randint(0, 10000000000000000000)
        data = {
        "static_vars": {
          "village_name": "string",
          "grampanchyat_name": "string",
